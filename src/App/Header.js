...
const Header = () => {
    ...
    return (
        <div data-testid={"header"} style={{ backgroundColor: 'rgba(82,111,142,0.25)' }} className='navbar navbar-expand-md navbar-light sticky-top'>
            <div className='container'>
                ...
                <nav className="my-2 my-md-0 mr-md-3 ">
                    ...
                    <div className={`${classname} navbar-collapse`} id="navbarCollapse" data-testid={"navbarCollapse"}>
                        <div className="navbar-nav">
                            <a className="p-2 nav-link" href="/"><strong>முகப்பு</strong></a>
                            <a className="p-2 nav-link" href="/all"><strong>அதிகாரங்கள்</strong></a>
                        </div>
                    </div>
                </nav>
            </div>
